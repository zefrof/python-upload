...
#Get episode number
now = datetime.now()
og_date = datetime.strptime('2021-02-28', "%Y-%m-%d")
...
font = ImageFont.truetype('Anton/Anton-Regular.ttf', 200)
